<aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="{{ url('admin/dashboard') }}" class="brand-link">
        <img src="{{ url('backend/img/marchedukit.png')}}" alt="marchedukit Logo" class="brand-image img-circle elevation-3"
           style="opacity: .8">
        <span class="brand-text font-weight-light">Edukit</span>
    </a>
    ...
    <div class="sidebar">
      <!-- Sidebar user panel (optional) -->
        <div class="user-panel mt-3 pb-3 mb-3 d-flex">
            <div class="image">
                <img src="{{url('backend/img/admin_photos/'.Auth::guard('admin')->user()->image)}}" class="img-circle elevation-2" alt="User Image">
            </div>
            <div class="info">
